...
!function (a) {
    ...
    a.Editable.image_commands = {
        ...
        debugger;
        var b = '<div class="marsdl-popup marsdl-image-popup" style="display: none; ">' +
            '<h4><span data-text="true" style="color:forestgreen">插入图片</span>' +
            '<span data-text="true"><font color="aqua">uploading...</font></span>' +
            '<i title="Cancel" class="fa fa-times" id="f-image-close-' + this._id + '"></i>' +
            '</h4>';
