/*!
 * www.marsdl.com
 * description 进行了部分汉化功能
 */
if ("undefined" == typeof jQuery)throw new Error("Marsdl requires jQuery");
!function (a) {
    "use strict";
    var b = function (c, d) {
    ...
    b.initializers = [], b.count = 0, b.VALID_NODES = ["P", "PRE", "BLOCKQUOTE", "H1", "H2", "H3", "H4", "H5", "H6", "DIV", "LI", "TD", "TH"], b.LANGS = [], b.DEFAULTS = {
        ...
        this.isLink ? this.$element.removeData("fa.editable") : (this.$element.replaceWith(this.getHTML()), this.$box && !this.editableDisabled && (this.$box.removeClass("marsdl-box"), this.$box.find(".html-switch").remove(), this.$box.removeData("fa.editable"), clearTimeout(this.typingTimer)))
        ...
        void 0 === c && (c = !1);
        var d = [], e = ["SPAN", "A", "B", "I", "EM", "U", "S", "STRONG", "STRIKE", "FONT", "IMG", "SUB", "SUP"],
            f = this;
        this.no_verify = !0;
        var g = function () {
        ...
        var a = "marsdl-element " + this.options.editorClass;
        ...
        return JSON.stringify({
            ...
            "class": this.$element.attr("class").replace(/marsdl-element/, "").replace(/not-msie/, "").replace(/ +(?= )/g, "").split(" ").sort().join(" ")
        })
        ...
        var a = '<div class="marsdl-popup marsdl-text-popup" style="display:none;">';
        return a += '<h4><span data-text="true">Edit text</span><i title="Cancel" class="fa fa-times" id="f-text-close-' + this._id + '"></i></h4></h4>', a += '<div class="f-popup-line"><input type="text" placeholder="http://www.marsdl.com" class="f-lu" id="f-ti-' + this._id + '">', a += '<button data-text="true" type="button" class="f-ok" id="f-edit-popup-ok-' + this._id + '">OK</button>', a += "</div>", a += "</div>"
    ...
    a.fn.editable = function (c) {
        ...
        if ("string" == typeof c) {
            ...
            return this.each(function () {
                ...
                if (!e[c])return a.error("Method " + c + " does not exist in Marsdl Editor.");
    ...
    a.Editable.commands = {
        ...
        createLink: {
            title: "添加链接", icon: "fa fa-link", shortcut: "(Ctrl + K)", callback: function () {
                this.insertLink()
            }, undo: !1
        },
        insertImage: {
        ...
        save: {
            title: "保存", icon: "fa fa-floppy-o", callback: function () {
                this.save()
            }, undo: !1
        },
        insertHorizontalRule: {
            title: "插入横线", icon: "fa fa-minus", callback: function (a, b) {
    ...
    a.Editable.prototype.getBoundingRect = function () {
        ...
        if (a(this.$editor.find('button.fr-bttn[data-cmd="' + b + '"]')).length) {
            var c = this.$editor.find('button.fr-bttn[data-cmd="' + b + '"]'), d = c.width(), e = c.height() - 15,
                f = c.offset().left + d / 2, g = c.offset().top + e;
    ...
    a.Editable.image_commands = {
        ...
        this.$image_editor = a('<div class="marsdl-popup marsdl-image-editor-popup" style="display: none">');
        ...
        var d = '<img class="fr-fin" data-fr-image-preview="' + c + '" alt="Image title" src="' + b + '" width="' + this.options.defaultImageWidth + '">',
            e = this.getSelectionElements()[0], f = this.getRange(),
    ...
    a.Editable.prototype.showLinkWrapper = function () {
        ...
        var a = '<div class="marsdl-popup marsdl-link-popup" style="display: none;">';
        a += '<h4><span data-text="true">添加链接</span><a target="_blank" title="Open Link" class="f-external-link" href="#"><i class="fa fa-external-link"></i></a><i title="Cancel" class="fa fa-times" id="f-link-close-' + this._id + '"></i></h4>', a += '<div class="f-popup-line fr-hidden"><input type="text" placeholder="Text" class="f-lt" id="f-lt-' + this._id + '"></div>';
        var b = "";
        if (this.options.linkList.length && (b = "f-bi"), a += '<div class="f-popup-line"><input type="text" placeholder="http://www.marsdl.com" class="f-lu ' + b + '" id="f-lu-' + this._id + '"/>', this.options.linkList.length) {
        ...
        this.addListener("hidePopups", this.hideLinkWrapper), this.$link_wrapper.on("mouseup", a.proxy(function (a) {
            ...
            var c = b.$link_wrapper.find("button#f-browse-links-" + b._id),
                d = b.$link_wrapper.find("input#f-lt-" + b._id), e = b.$link_wrapper.find("input#f-lu-" + b._id),
    ...
    var f, g, h, i = "2.7.1", j = {}, k = b.documentElement, l = "modernizr", m = b.createElement(l), n = m.style,
        o = ({}.toString, " -webkit- -moz- -o- -ms- ".split(" ")), p = {}, q = [], r = q.slice,
        s = function (a, c, d, e) {
    ...
    a.Editable.TAG_ORDER = ["table", "thead", "tbody", "tfoot", "tr", "th", "td", "ul", "ol", "li", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "p", "div", "a", "strong", "em", "strike", "u", "span", "iframe", "object", "param", "video", "source"], a.Editable.SEPARATE = ["th", "td", "li", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "p", "div"], a.Editable.END_AT_SAME_INDEX = ["table", "thead", "tbody", "tfoot", "tr", "th", "td", "a", "span", "iframe", "div", "object", "param"], a.Editable.prototype.isClosingTag = function (a) {
        ...
        for (var o = 0; o < b.length; o++)if (d = b.charAt(o), "<" == d) {
            ...
            if (-1 !== p) {
                ...
                var q = this.isClosingTag(e), r = null,
                    s = e.replace(/^<[\S\s]* style=("[^"]+"|'[^']+')[\S\s]*>$/gi, "$1"), t = {};
    ...
    }, a.Editable.prototype.marsdlDOM = function (b) {
        ...
        var d, e, f, g, h = this.mapDOM(b, c), i = this.marsdlDOM(h.format), j = h.simple_tags, k = h.text, l = {};
