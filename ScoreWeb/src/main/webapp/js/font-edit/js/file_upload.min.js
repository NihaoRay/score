...
!function (a) {
    a.Editable.commands = a.extend(a.Editable.commands, {
        ...
        var b = '<div class="marsdl-popup marsdl-file-popup" style="display: none;"><h4><span data-text="true">Upload file</span><i title="Cancel" class="fa fa-times" id="f-file-close-' + this._id + '"></i></h4>';
        ...
        this.restoreSelectionByMarkers(), this.focus(), this.insertHTML('<a class="fr-file" href="' + this.sanitizeURL(a) + '">' + b + "</a>"), this.hide(), this.hideFileLoader(), this.saveUndoStep(), this.focus(), this.triggerEvent("fileUploaded", [b, a])
    }
}(jQuery);